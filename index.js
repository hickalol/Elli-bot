  ...
  if (message.author.bot)
    return;
      ...
      if (message.content === 'pet me') {
         const responses = ["here baby, pets.. <3", "https://tenor.com/65pR.gif", "https://cdn.weeb.sh/images/SJmW1RKtb.gif", "https://tenor.com/MLKi.gif", "https://tenor.com/bem13.gif", "https://tenor.com/bVECi.gif", "https://tenor.com/Mkv6.gif", "https://tenor.com/bvoza.gif", "https://tenor.com/bSNxe.gif", "https://tenor.com/bW3uk.gif", "https://tenor.com/bvozg.gif", "https://tenor.com/bebMV.gif", "https://tenor.com/btfWd.gif", "https://tenor.com/bXzMg.gif"];
      ...
      if (message.content === 'i feel bad') {
         const responses = ["hm?", "why so baby?", "*scratches behind your ear* whats wrong?", "I'm here..", "*holds your hand let me make you feel better.."];
      ...
      if (message.content === "mama") {
         const responses = ["what is it pancake?", "yes cutie?", "*picks you up and places you on my lap* hm?", "cuuuuuutie!"];
      ...
      if (message.content === 'guess wat') {
         const responses = ["hm?", "*rubs your cheek* what is it?"];
      ...
      if (message.content === "can we snuggle?") {
         const responses = ["teehee..", "come here baby", "snuggles..", "needy girl, of course we can", "do you wanna snuggle under my hoodie..?", "*wraps my arms around you* come here", "*scratches behind your ear*", "yes we can~"];
